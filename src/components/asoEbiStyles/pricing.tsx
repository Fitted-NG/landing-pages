        ...
        <div className="grid lg:grid-cols-3 md:gap-10 items-stretch">
          <div className="">
            ...
            <div className="p-4 md:p-6 border border-t-0 border-[#5773FF] h-full flex flex-col justify-between">
              ...
              <a
                href="https://groups.fitted.fashion/signup?group=aso-ebi&price=50000"
          ...
          <div className="">
            ...
            <div className="p-4 md:p-6 border border-t-0 border-[#5773FF] h-full flex flex-col justify-between">
              ...
              <a
                href="https://groups.fitted.fashion/signup?group=brides-maids&price=40000"
                className="w-full text-center bg-pink-fitted hover:bg-opacity-80 text-white py-[10px] px-[18px] text-sm rounded-[8px] mt-5"
              >
                Create Order
              </a>
          ...
          <div className="">
            ...
            <div className="p-4 md:p-6 border border-t-0 border-[#5773FF] h-full flex flex-col justify-between">
              ...
              <a
                href="https://groups.fitted.fashion/signup?group=familys&price=60000"
                className="w-full text-center bg-pink-fitted hover:bg-opacity-80 text-white py-[10px] px-[18px] text-sm rounded-[8px] mt-5"
              >
                Create Order
              </a>
