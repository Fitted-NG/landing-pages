  ...
  return (
    <section className="bg-white sm:px-16 sm:py-24 py-12">
      <div className="flex flex-col justify-center items-center">
        <div className="bg-[#F2F4F5] p-1 px-3 rounded-full flex items-center">
          <button
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center mt-5 gap-10">
          ...
          <div className={`${currentTab === 1 ? "flex" : "hidden"} relative`}>
            ...
            <div className="absolute inset-0 top-44 flex flex-col items-center justify-center text-white">
              ...
              <p className="w-[300px] font-avenir text-sm font-normal text-center">
                Let customers input their measurements manually, as measured by
                yourself or a tailor
              </p>
            </div>
          </div>
          ...
          <div className={`${currentTab === 2 ? "flex" : "hidden"} relative`}>
            ...
            <div className="absolute inset-0 top-44 flex flex-col items-center justify-center text-white">
              ...
              <div className="mt-4">
                <button className="bg-[#EAFFF9] border border-[#00C48C] p-2 px-6 rounded-full text-[#00C48C]">
                  Coming Soon
                </button>
