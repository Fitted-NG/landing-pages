    ...
    <div className="justify-end md:gap-3 lg:gap-5 hidden md:flex -mt-[45px] container mx-auto xl:pl-72">
      <nav className="bg-none mt-2">
        <ul className="flex justify-center space-x-6">
          ...
          <li>
            <a href="https://fitted.fashion" className="text-white font-avenir text-sm font-medium">
              Fitted.fashion
            </a>
          </li>
          <li>
            <a href="https://support.fitted.ng" className="text-white font-avenir text-sm font-medium">
              Support
            </a>
          </li>
          <li>
            <a href="https://blog.fitted.ng" className="text-white font-avenir text-sm font-medium">
              Blog
            </a>
          </li>
        </ul>
      ...
      <a href="https://tailors.fitted.ng/signin">
        <button className="py-2 px-3 bg-white text-[#5773FF] rounded-lg cursor-pointer">
          Sign In
        </button>
      </a>
      
      <a href="https://tailors.fitted.ng/signup">
